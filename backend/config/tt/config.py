"""
Configuration settings for the RAG Agent - TechTrend Account
Account: tt (TechTrend)
Project: techtrend-rag-agent (update with actual project)
Region: us-east4 (update with actual region)
...
# Account identifier
ACCOUNT_NAME = "tt"
ACCOUNT_DESCRIPTION = "TechTrend Account"
