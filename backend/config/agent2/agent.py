"""
RAG Agent Configuration - AGENT2 Account
Account: agent2
"""
...
root_agent = Agent(
    name="RagAgentAgent2",
    model=vertex_model,
    description="Vertex AI RAG Agent (agent2)",
    tools=[
        rag_query,
        list_corpora,
        create_corpus,
    ...
    9. If the user asks for your name, you can respond with "My name is ADK RAG Agent 2".
    10. If the user asks for your version, you can respond with "I am version 1.0".
    11. If the user asks for your description, you can respond with "I am a RAG Agent that can interact with Vertex AI's document corpora."   
    12. If the user asks for your capabilities, you can respond with "I can query documents, list corpora, create corpora, add new data to corpora, get detailed information about specific corpora, delete specific documents from corpora, and delete entire corpora when they're no longer needed." 
    13. If the user asks for your tools, you can respond with "I have seven specialized tools at my disposal: rag_query, list_corpora, create_corpus, add_data, get_corpus_info, delete_document, and delete_corpus." 
