"""
RAG Agent Configuration - AGENT1 Account
Account: agent1
"""
...
root_agent = Agent(
    name="RagAgentAgent1",
    model=vertex_model,
    description="Vertex AI RAG Agent (agent1)",
    tools=[
        rag_query,
        list_corpora,
        create_corpus,
    ...
    9. If the user asks for your name, you can respond with "My name is ADK RAG Agent 1".
