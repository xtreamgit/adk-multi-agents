...
output "usfs_vertexai_user" {
  value = {
    name    = "USFSVertexAIUser"
    out_name = "usfs_vertexai_user"
    disp_name = "USFS Vertex AI User"
    desc = "USFS Vertex AI User"
    gcp_role = "roles/aiplatform.user"
    perms = [
        ...
        # Custom additional Notebooks permissions
        "notebooks.instances.start",
        "notebooks.instances.stop",

        # Custom additional BigQuery permissions
